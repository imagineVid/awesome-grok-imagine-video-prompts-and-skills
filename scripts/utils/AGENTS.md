...
Member map
prompt-repository.ts: Local JSON repository exposing Grok Imagine prompts, video workflows, official cases, and stable sorting.
i18n.ts: English publication-copy facade with an explicit future-locale extension point.
...
workflow-copy.ts: English descriptions for the six video-production workflow groups.
